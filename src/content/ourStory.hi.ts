...
export const ourStory = {
  ...
  vasOrigin: {
    eyebrow: 'पहला अध्याय',
    headline: 'वास',
    body: 'उसी नाम से आया वास, हमारा मेंसवियर शर्टिंग फैब्रिक ब्रांड और सवायावास जिस भी चीज़ के लिए खड़ा है उसकी पहली अभिव्यक्ति। जड़ वस् आगे बढ़ती है: ऐसा फैब्रिक जो उस अनुशासन से बना है जो एक परिवार ने तीन पीढ़ियों में सीखा कि एक शर्ट को कैसा महसूस होना चाहिए।',
