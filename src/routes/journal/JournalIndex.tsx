...
import { journalPosts, journalCategories } from '@/content/journal.en'
    ...
    <Section tone="ivory" className="pb-16 pt-32 sm:pb-20 sm:pt-40">
      <Container>
        <Reveal className="max-w-2xl">
          ...
          <h1 className="mt-5 text-4xl uppercase leading-[1.05] sm:text-5xl lg:text-6xl">Journal</h1>
          <p className="u-prose mt-6 text-sm leading-relaxed">
            Notes on fabric, craft and sourcing, from the mill floor to the cutting table.
          </p>
        </Reveal>
      ...
      <Container className="mt-16">
        ...
        {grid.length === 0 && (
          <p className="mt-8 text-sm text-stone">No posts in this category yet.</p>
        )}
      </Container>
    </Section>
  )
